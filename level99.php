...
<body>
    ...
    <section class="container mt-5 pt-5 mb-3 text-white text-center">
        <div class="row">
            <h1 class="mb-3"><span class="border-bottom border-danger">Hurray!!!</span></h1>
            <p>You have finished the game.</p>
            <div class="col-md-8 offset-md-2" >
                <div class="row">
                    <div class="col-lg-12">
                        <img class="img-fluid" src="./assets/img/lvls/lvl99.jpg" style="border-radius:25px;padding:0px;">
                    </div>
                </div>
                <br/>
            </div>
